...
public class TS implements AIInterface{
    ...
    public boolean GetMove(){
        System.err.println("TS GetMove got called.");
        return false;
    }


    public boolean GetMove(double min, double max, double mid) {
        //if(valuess!=null) {
        //OPmoves();}
        lower = min;
        upper = max;
        ...
        ArrayList<Player> Playerlist = new ArrayList<>();   //FIXME IN ORIGINAL CODE CHANGE TO THIS
